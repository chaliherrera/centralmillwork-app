...
export interface IngDealEnCurso { proyecto_id: number; codigo: string; nombre: string; cliente: string | null; estado: string; deal_estado: DealEstado; fecha_objetivo: string | null; n_tareas: number; portal_token: string | null; deal_aprobado_at: string | null; cliente_rechazo: boolean }
